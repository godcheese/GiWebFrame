...
defined('CONTENT_PATH') or define('CONTENT_PATH', ROOT_PATH.'content'.DS); //根目录
...
defined('EXT') or define('EXT', '.php'); //php后缀
defined('TPL_EXT') or define('TPL_EXT', '.tpl.html'); //模版后缀
