...
return array(
    ...
    'default_error_msg_controller'      =>  'error',    //错误信息默认处理controller类
    ...
    //'default_view_layer'       =>  'view', // 默认的视图层名称
    ...
    'trace_max_recode'      =>  100,    // 每个级别的错误信息 最大记录数
   

    // 模版设置
    //'templ_deny_func_list'   =>  'echo,exit',    // 模板引擎禁用函数
    //'templ_deny_php'         =>  false, // 默认模板引擎是否禁用PHP原生代码
    //'templ_l_delim'          =>  '{',            // 模板引擎普通标签开始标记
    //'templ_r_delim'          =>  '}',            // 模板引擎普通标签结束标记
    //'templ_layout_item'      =>  '{__CONTENT__}', // 布局模板的内容替换标识
    ...
    'url_pathinfo_delim'     =>  '/',	// PATHINFO模式下，各参数之间的分割符号
