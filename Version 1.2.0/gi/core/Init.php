...
class Init{
    ...
    public static function run(){
        if(Router::isSelf()){ // 判断是否为index.php或admin.php本身
    ...
    public static function loadClass($class_name){
        ...
        if($class_name!=''){
            ...
            if(defined('APP_PATH')){
                $app_controller_file=APP_PATH.DS.c('default_controller_layer').DS.$class_name.'.'.c('default_controller_layer').EXT;
                $app_model_file=APP_PATH.DS.c('default_method_layer').DS.$class_name.'.'.c('default_model_layer').EXT;
    ...
    public static function initController($controller_name = ''){
        ...
        if($controller_name == '') {
            ...
            //为空时自动调用默认controller
            Router::getRequest(c('default_controller_request'), $controller_name);
        }
    ...
    public static function handLoad($controller_name,$method_name=''){
        ...
        if (is_object($obj)) {
            ...
            $m = Router::getRequest(c('default_method_request_key'));
            if ($m != '') {
